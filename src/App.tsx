        ...
        {loading ? (
          ...
          <div className="space-y-10">
            ...
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
              <div
                className="animate-slide-up rounded-2xl border border-stone-200 bg-white p-8 shadow-sm"
                ...
                <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
                  {topProperties.map((insight, idx) => (
                    <button
                      ...
                      className="group relative overflow-hidden rounded-xl border border-stone-200 bg-stone-50 p-5 text-left transition-all duration-300 hover:-translate-y-1 hover:border-amber-500 hover:shadow-lg hover:shadow-amber-100/80"
                    >
              ...
              <div className="animate-slide-up rounded-2xl border border-stone-200 bg-white p-8 shadow-sm" style={{ animationDelay: '0.6s' }}>
